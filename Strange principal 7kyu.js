...
//PREP
//P:An integer that is always greater than or equal to 0
//R: an integer that represents the number of open lockers
//E: n=2, 1 open locker
//P: function(n){
//     create the array of lockers equal to n of c for closed
//     initiate a for loop with an initiation of i=0, condition of i<=n, final expression of i++
//     for each iteration of n, close the lockers for each nth lockers or open if it is closed
...
function numOfOpenLockers(n){
    ...
    for (let j=1; j<n; j++){
      ...
      return array.filter(x=>x=='o').length 
    }